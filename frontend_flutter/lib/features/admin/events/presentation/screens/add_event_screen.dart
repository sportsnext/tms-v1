...
class _AddEventScreenState extends State<AddEventScreen> {
  ...
  Future<void> _save() async {
    ...
    final url = isEdit
        ? "https://dev.sports-next.com/api/events/${widget.event!.id}/update"
        : "https://dev.sports-next.com/api/events";
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        _showError("Failed to save event");
      }
    } catch (e) {
      print("API ERROR: $e");
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            _ModalFooter(
              saving: _saving,
              saveLabel: widget.event == null ? "Create Event" : "Update Event",
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: _FooterOutlineBtn(label: "Cancel", onTap: onCancel),
          ),
          const SizedBox(width: 14),
          Expanded(
            child: _FooterSolidBtn(
...
class _FooterSolidBtn extends StatelessWidget {
  final String label;
