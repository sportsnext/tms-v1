...
// Place at: lib/features/admin/sports/presentation/screens/add_sport_screen.dart

class AddSportScreen extends StatefulWidget {
  final void Function(SportModel sport) onSave;
  const AddSportScreen({super.key, required this.onSave});
...
class _AddSportScreenState extends State<AddSportScreen> {
  ...
  String _sportType = 'Team';
  String _icon = '🎾';
  String _preset = 'Padel';
  bool _saving = false;

  // Scoring rules
  int _sets = 3;
  int _gamesPerSet = 6;
  bool _hasTieBreak = true;
  int _tieBreakAt = 6; // game score that triggers tiebreak (e.g. 6-6)
  int _tieBreakPoints = 7; // minimum points to win tiebreak
  int _tieBreakDiff = 2; // win-by difference in tiebreak
  bool _goldenPoint = true; // sudden death at game deuce
  ...
  void _applyPreset(String preset) {
    ...
    if (p == null) return; // Custom — user fills manually
  ...
  Future<void> _save() async {
    ...
    try {
      final url = Uri.parse("https://dev.sports-next.com/api/sports");

      final body = {
        'sport_name': _nameCtrl.text.trim(),
        'sport_type': _sportType,
        'scoring_type': 'Sets',
        'max_players_per_team': _sets,
      };
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        print("SPORT CREATE ERROR: ${response.body}");
      }
    } catch (e) {
      print("CREATE SPORT ERROR: $e");
    }
  ...
  Widget build(BuildContext context) {
    return _SportFormDialog(
      title: "Add Sport",
      subtitle: "Create a sport with Padel scoring rules",
      isEdit: false,
      saving: _saving,
...
class _SportFormBody extends StatelessWidget {
  ...
  // Callbacks — basic
  final void Function(String) onPreset, onSportType, onIcon;
  // Callbacks — scoring
  final void Function(int) onSets,
      onGamesPerSet,
      onTieBreakAt,
      onTieBreakPoints,
      onTieBreakDiff;
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          spacing: 8,
          runSpacing: 8,
          children: SportPresets.presetNames
              .map(
                (p) => _PresetChip(
                  label: p,
                  selected: preset == p,
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: _inputDeco("e.g. Padel", Icons.sports_outlined),
                  ),
                ],
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: hasTieBreak ? const Color(0xFFF5F3FF) : Colors.grey.shade50,
              ...
              child: Column(
                ...
                children: [
                  ...
                  _ToggleRow(
                    ...
                    sublabel:
                        "Sudden death instead of advantage — 1 point decides the game",
                    value: goldenPoint,
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: selected ? const Color(0xFF0A46D8) : Colors.grey.shade200,
    ...
    child: InkWell(
      ...
      child: SizedBox(
        ...
        child: Icon(
          icon,
          size: 18,
          color: enabled ? const Color(0xFF0A46D8) : Colors.grey.shade300,
        ),
      ),
    ),
  );
      ...
      child: Row(
        children: [
          ...
          AnimatedContainer(
            ...
            height: 22,
            decoration: BoxDecoration(
              color: value ? const Color(0xFF0A46D8) : Colors.grey.shade300,
