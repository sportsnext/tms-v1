...
class _EditPlayerScreenState extends State<EditPlayerScreen> {
  ...
  void initState() {
    ...
    _ageGroup = PlayerModel.ageGroups.contains(p.ageGroup)
        ? p.ageGroup
        : '18–30';
  ...
  Future<void> _save() async {
    ...
    try {
      final url = Uri.parse(
        "https://dev.sports-next.com/api/players/${widget.player.id}"
      );
      ...
      if (response.statusCode == 200) {
        ...
        final updatedplayer = PlayerModel.fromJson(jsonData['data']);
