...
// Place at: lib/features/admin/players/presentation/screens/add_player_screen.dart

class AddPlayerScreen extends StatefulWidget {
  final void Function(PlayerModel player) onSave;
  const AddPlayerScreen({super.key, required this.onSave});
...
class _AddPlayerScreenState extends State<AddPlayerScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      final url = Uri.parse("https://dev.sports-next.com/api/players");
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final player = PlayerModel.fromJson(jsonData);
    ...
    children: [
      ...
      TextFormField(
        ...
        decoration: _fieldDecoration(
          "Any additional notes about this player...",
          Icons.notes_rounded,
        ),
      ),
      const SizedBox(height: 24),
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Icon(
                      d.icon,
                      color: isSel ? d.color : Colors.grey.shade400,
                      size: 22,
                    ),
                  ),
                  const SizedBox(height: 8),
